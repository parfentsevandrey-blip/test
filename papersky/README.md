...
Погодное приложение для Android 17 (API 37) в духе **классического скевоморфизма** ранних iOS.
Это не «приложение с бумажной темой», а вещь: шкатулка-диорама за стеклом, в которой живёт небо,
вырезанное из бумаги, и россыпь настоящих предметов рядом с ней на столе — тетрадный листок с
заметкой, полоска миллиметровки, каталожная карточка, картонные плитки, открытка с маркой,
крафтовая бирка на канцелярской кнопке. Главное ощущение — **уют**: тёплый свет, мягкие тени,
фактура под пальцем, живая погода за стеклом.
...
Все элементы, материалы, свет, шрифты, пружины анимаций, эффекты сцены, жесты и бюджеты кадра
описаны в **[DESIGN_DOCTRINE.md](DESIGN_DOCTRINE.md)** («Бумажный уют»). Числа в ней не «примерные»:
код (`design/Materials.kt`, `design/Light.kt`, `design/Motion.kt`, `design/Components.kt`)
ссылается на них. Коротко:

- **Всё — предмет из реального материала.** Хлопковая бумага с рваным краем, тетрадный лист с
  перфорацией, линовкой и красным полем, миллиметровка, каталожная карточка, картон (chipboard),
  крафт, открытка, полароид, калька, васи-скотч, бук, лён, пробка, латунь. Фактуры процедурные,
  бесшовные, генерируются один раз (`scene/MaterialTextures.kt`).
- **Один свет — сверху-слева.** У каждого предмета две тени (контактная и мягкая) по пяти уровням
  подъёма, блик по верхней кромке, текст — оттиском (letterpress).
- **Бумага не темнеет — её освещают.** Ночью нет «тёмной темы»: листы согревает настольная лампа,
  на столе лежит тёплое пятно света, углы тонут в полумраке. На закате бумага золотится, в мороз
  по углам листов нарастает иней, вспышка молнии на миг освещает весь стол. То же — в виджетах.
- **Одна доминанта — Manrope**, **один акцент — Caveat** только для того, что «написано от руки»
  синими чернилами (заметки дня, оборот плиток, бирка шнурка). Цифры — всегда Manrope с `tnum`.
- **Иконки погоды — вырубные стикеры** с белой обводкой и тенью. В приложении они живые: лучи
  вращаются, капли падают, снежинки кружатся, звёздочки у луны мерцают.
- **Физика вместо анимации.** Листы ложатся на стол, вдавливаются под пальцем, качаются на скотче,
  плитки переворачиваются с глухим стуком, записки разворачиваются на петле, полароиды отрываются
  от кнопки. Всё на пружинах из таблицы доктрины.

![Приложение](docs/app_home.jpg)

## Сцена

Небо с акварельной заливкой; пять вырезанных листов пейзажа с воздушной перспективой, снежными
шапками, еловыми грядами и туманом у подножий; на ближнем лугу — **бумажная деревушка** с
черепичными крышами, окнами в переплёт, трубами и фонарём, и деревья, которые гнутся на ветру.
12 «гуашевых» палитр непрерывно смешиваются по солнцу, облачности и осадкам.
...
| Ночь | звёзды трёх групп и яркие с лучиками, падающие звёзды, луна с настоящей фазой, **окна деревушки светятся и мерцают**, фонарь с ореолом и конусом света |
| Тёплая ночь | светлячки над лугом |
| Пасмурно | бумажный «фестон» облаков вдоль верхнего края |
| Дождь | три плана глубины, брызги о луг, **капли на стекле** собираются и стекают |
| Снег | **снежинки-звёздочки**, мягкие хлопья, снег на горах, крышах и елях |
| Гроза | ветвистая молния, вспышка освещает стол, раскат с задержкой |
| Холодно | дым из труб, сносимый ветром; в мороз — иней на листах |
| После дождя | радуга |
...
| Где | Что происходит |
|---|---|
| **Температура** | Цифры вырезаны из картона (фактура, торец, тень) и перекатываются по разрядам. Под ними крафтовый билет на скотче с условиями, макс/мин и «ощущается» |
| **Бирка места** | Висит на канцелярской кнопке и раскачивается на «нитке», когда место меняется |
| **Шнурок** | Pull-to-refresh как у лампы: хлопковая нить, буковая бусина, крафтовая бирка «потяни»; тянется с сопротивлением, щёлкает под пальцем, на пороге отчётливый клик, после отпускания пружинит и качается, пока идёт загрузка |
| **Небо** | Тап — круги на стекле и порыв ветра; тап по солнцу или луне — раскрутка на пружине; удержание под дождём — капли стучат по пальцу; свайп — порыв: облака ускоряются, деревья гнутся, дым сносит |
| **Наклон телефона** | Параллакс бумажных слоёв |
| **Заметки дня** | Тетрадный лист на скотче; рукопись пишется синими чернилами; тап — лист качается на скотче |
| **По часам** | Миллиметровка; кривая прорисовывается цветным карандашом, стикеры живые; тап или удержание с ведением — полоска кальки едет за пальцем, а небо «репетирует» этот час |
| **Десять дней** | Каталожная карточка на кнопке; день разворачивается, как сложенная записка на петле, в ней — крафтовые бирки с восходом, закатом, ветром, осадками, УФ |
| **Плитки деталей** | Картон с наклеенным ярлыком: компас с бумажной стрелкой, банка с водой, латунный барометр, стеклянный термометр, луна с кратерами. Тап — плитка переворачивается, на обороте рукописная записка, приземляется с глухим стуком |
| **Места** | Пробковая доска: полароиды на кнопках, снимок «проявляется», у выбранного места он живой и приколот красной кнопкой; свайп влево — полароид отрывается с шорохом |
| **Настройки** | Льняная скатерть, листы хлопковой бумаги, бумажные переключатели в пазах, бирки-выбор, лента с буковой бусиной |
| **Виджеты** | Крафтовый стол: установленные виджеты под калькой на скотче, пресеты — открытки с маркой и штемпелем |
| **Переходы** | Новый лист въезжает снизу и ложится, старый уходит вглубь и тонет в полумраке; predictive back |

UI-отклик идёт через `performHapticFeedback` (уважает системную настройку), погодные и
«материальные» текстуры — примитивы `VibrationEffect.Composition`: картон — `THUD`, кнопка —
`CLICK`, отрыв от скотча — россыпь тиков, гроза — огибающая на Android 16+. Сила отклика и
...
- **Фон-диорама** рисуется тем же рендерером, что и приложение, в bitmap ровно под размер виджета
  ...
  секции лежат на **листах хлопковой бумаги** с рваным краем, фактурой волокон, тенью, световой
  кромкой и полоской васи-скотча. Ночью бумага не темнеет, а тёплая от лампы — в любой палитре.
  Туда же карандашом впечатана **температурная кривая**, на которой «сидят» подписи часов. За
  текстом на небе — мягкая подложка для читаемости, облака и светила не заходят под крупную
  температуру.
...
- Никаких «продвинутых» режимов смешивания (OVERLAY и т. п. заставляют GPU читать кадр обратно):
  фактуры материалов — обычная альфа, генерируются один раз в фоне при старте.
- Реквизит диорамы (деревья, дым, огни окон, фонарь) — отдельный лёгкий слой; дома запечены в
  кешированный слой луга. У стикеров запекается тело с тенью, а каждый кадр дорисовываются только
...
├── scene/           палитры, SceneState, PaperSceneRenderer, GlyphRenderer (стикеры), фактуры материалов
├── design/          материалы, свет комнаты, пружины и уровни подъёма, тема, скевоморфные
│                    компоненты (листы, скотч, кнопки, бирки, открытки, марки), тактильный движок
...
DESIGN_DOCTRINE.md   доктрина дизайна «Бумажный уют»
```
...
Шрифты Manrope и Caveat распространяются по SIL Open Font License (см. `third_party/fonts`).
