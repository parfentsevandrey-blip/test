...
Тема по умолчанию — **«Камин»**: уютная комната, в которой горит настоящий огонь, а погода —
за арочным окном. Есть ещё «Живое небо» (гравюра на весь экран) и меланхоличная «Офелия».
...
| Дождь | три плана штрихов с яркой «головой» и бледным хвостом, **завесы по ветру**, капли у самого «объектива» не в фокусе, брызги о луг, **морось бусин на стекле**, крупные капли стекают дрожащей дорожкой |
| Снег | точки трёх размеров, ближние хлопья кувыркаются, у глаза — крупные размытые хлопья, **снежные шапки на пиках**, иней на листах |
| Туман | на GPU — клубящийся туман из двух слоёв шума, гуще у горизонта |
| Гроза | молния ломается в двух масштабах, с отростками и размытым свечением, облако подсвечено изнутри, вспышка освещает экран, раскат с задержкой |
| После дождя | едва заметная радуга |

## Тема «Камин» (по умолчанию)

![Камин](docs/hearth.jpg)

Комната у камина: обои в тихую полоску, арочное окно, каменный портал, дубовая полка со свечами
и книгами, плита, половицы и ковёр. **Огонь** — GPU-шейдер (`scene/Shaders.kt`): ряд языков
разной высоты вдоль поленьев, края рвёт восходящая турбулентность, верхушки отрываются клочьями,
цвет — по температуре пламени. Он горит сильнее в мороз, клонится от ветра, из него летят искры,
в трещинах поленьев тлеет жар, свет мерцает по комнате и по нижним стёклам окна. **Тап по огню** —
треск в руке, огонь вспыхивает и выбрасывает искры. В окне — живая гравюра: дождь, снег, молнии,
иней по углам стёкол и снег на отливе. В виджетах комната вписывается над панелями, дождь идёт
только за окном, а отсвет огня мерцает прямо на домашнем экране.
...
а на GPU по воде идут медленные волны с бликами неба.
