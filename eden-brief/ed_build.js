  ...
  sections: [{
    ...
    children: [
      ...
      ...bullets([
        ...
        [txt('Цена выставлена выше всего, что продаётся рядом. '), txt('Расчётные 4,4 млн ₽ за метр дороже 67 квартир из 70 в пяти соседних клубных домах. Ближайший аналог по продукту — «Кло 17» без отделки — идёт по 2,63 млн ₽ за метр: EDEN дороже на 67 %. Единственный сопоставимый по цене «Stella di Mosca» — готовый дом с ремонтом, а не котлован.', { bold: true })],
        [txt('Главный риск — ёмкость спроса. '), txt('Дому нужно продавать около семи резиденций в год дороже миллиарда рублей. Весь московский рынок таких сделок — 20–25 в год, а во всей соседней подборке из 70 квартир дороже миллиарда стоят ровно две. Предложение при этом растёт быстрее спроса. Срок реализации будет длинным, и он должен быть в ожиданиях с самого начала.', { bold: true })],
        [txt('Конкуренты дешевле и готовы раньше. '), txt('«Никитский-6» в трёхстах метрах — 3,19 млн ₽ за метр с чистовой отделкой и сдачей в 2026 году. «Фамильный дом Люче» от MR Group в двухстах метрах — 2,94 млн ₽ с отделкой, 26 квартир в продаже. «Кло 17» — 2,63 млн ₽ без отделки.', { bold: true })],
