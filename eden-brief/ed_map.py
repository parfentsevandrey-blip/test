...
проектов, сверены 17.08.2026:
  ...
  Брюсов                   Брюсов переулок, 2/14          55.75770 / 37.60640

Циан даёт адрес «Брюсова» без строения — просто «Брюсов переулок, 2».
В OSM это квартал из шести строений 2/14, пин поставлен в его середину;
точность порядка полусотни метров, для карты локации этого достаточно.
...
CEN = (37.59960, 55.75384)          # центр сдвинут к северу, чтобы вошёл «Брюсов»
...
SITES = [
    (37.60640, 55.75770, 'Брюсов',              '5 608 тыс. ₽/м² · с отделкой',  -70, -172, 'right'),
