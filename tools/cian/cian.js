...
function stateFromEvidence(raw) {
  ...
  /* Идущие работы решают раньше голого бетона, и порядок здесь выстрадан.
     Сначала было наоборот, и целевой пентхаус на Льва Толстого получил
     «бетон» при уликах «штабели газоблока, перегородки выложены наполовину,
     ограждающая лента, часть стен уже оштукатурена и покрашена». Голый бетон
     виден в любой квартире посреди ремонта — это не отличительный признак,
     а фон. Отличительный — следы работ, и он говорит то, чего «бетон» не
     говорит: деньги в отделку уже вложены, и покупатель наследует чужой
     наполовину исполненный проект, а не чистый лист. */
