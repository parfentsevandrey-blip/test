...
_Всего источников: 269 в 20 категориях._
...
4. Кредитные рейтинги и кредитный research эмитентов (7)
5. Первичные раскрытия листингованных эмитентов (IR) (12)
6. Консенсус аналитиков и sell-side estimates (5)
...
19. Суб-секторные дески (логистика, ритейл, data centres, living-ниши, отели, life sciences) (43)
20. Энергосети, азот, физические барьеры стройки и СМИ (NL/EU) (28)
...
- ○ **[Sustainalytics — ESG Risk Ratings (Real Estate)](https://www.sustainalytics.com/esg-ratings)** `[freemium · global · непрерывно]`
  - что даёт: ESG Risk Rating по листингованным REIT/property-компаниям: managed vs. unmanaged risk, controversies, экспозиция к transition-риску по портфелю недвижимости.
  - аналитику: Дополняет кредитные рейтинги оценкой transition-риска зелёных активов (связь ESG-профиля с рефинансированием и стоимостью капитала green bonds) для NL-REIT (CTP, WDP, Wereldhave, NSI).
  - метрики: ESG risk score, controversy level, carbon risk exposure, management gap  ·  сегменты: ритейл, индустриал, жильё
- ○ **[MSCI ESG Ratings — Real Estate Issuers](https://www.msci.com/our-solutions/esg-investing/esg-ratings)** `[платн. · global · ежегодно + непрерывно]`
  - что даёт: ESG-рейтинг (AAA–CCC) по листингованным property-компаниям с разбивкой по key issues (climate change, resource use, governance); используется как ESG-прокси в credit-моделях инвесторов.
  - аналитику: Второй независимый ESG-взгляд рядом с Sustainalytics для оценки climate/transition risk NL-REIT, релевантен при анализе спреда green bonds и covenant-рисков.
  - метрики: ESG rating (AAA-CCC), key issue score, carbon intensity, governance score  ·  сегменты: ритейл, индустриал, жильё
...
- ● **[TIKR — Analyst Estimates & Consensus](https://www.tikr.com/)** `[freemium · global · непрерывно]`
  - что даёт: Агрегатор консенсус-оценок (revenue, EPS, NAV/FFO) и истории ревизий по листингованным компаниям, включая европейские REIT (CTP, WDP, Wereldhave, NSI, Vastned).
  - аналитику: Кросс-проверка консенсуса и трекинг ревизий EPS/FFO по NL-REIT дополнительно к MarketScreener/Investing.com; удобная историческая динамика оценок аналитиков.
  - метрики: consensus EPS/FFO, estimate revisions, consensus NAV, number of analysts  ·  сегменты: все сегменты
- ○ **[Simply Wall St — Analyst Consensus & Fair Value](https://simplywall.st/)** `[freemium · global · непрерывно]`
  - что даёт: Консенсус-таргеты, распределение рейтингов и fair-value модель по листингованным REIT (CTP, WDP, Wereldhave, NSI, ECP), визуализация ревизий прогнозов.
  - аналитику: Быстрый третий независимый срез консенсуса и fair-value для триангуляции с MarketScreener/Investing.com/TIKR по NL-релевантным именам.
  - метрики: consensus target price, fair value estimate, buy/hold/sell distribution, estimate revisions  ·  сегменты: все сегменты
...
- ○ **[Dokvast](https://www.dokvast.com/)** `[откр. · NL · нерегулярно]`
  ...
  - аналитику: Оперативный/контекстный слой; для фактов поднимать к первоисточнику (Правило И-1).
  - сегменты: индустриал
- ○ **[Supply Chain Dive — Warehousing & Logistics](https://www.supplychaindive.com/topic/warehousing-distribution/)** `[откр. · global · непрерывно]`
  - что даёт: Англоязычное отраслевое издание по логистике и цепочкам поставок: near-shoring, автоматизация складов, аренда DC, инвестиции 3PL/операторов, включая европейские/NL-сюжеты.
  - аналитику: Быстрый англоязычный срез новостей индустриального/логистического сегмента для иностранных инвесторов; контекст спроса occupier-рынка вне NL-язычных источников; для фактов поднимать к первоисточнику.
  - сегменты: индустриал
- ○ **[Logistics Manager — UK/European Warehousing News](https://www.logisticsmanager.com/category/warehousing/)** `[откр. · EU · непрерывно]`
  - что даёт: Англоязычный журнал по складской логистике и цепочкам поставок, фокус на Великобританию с материалами по Европе: сделки по складам, автоматизация, девелопмент DC, рынок труда в логистике.
  - аналитику: Дополнительный англоязычный новостной канал по индустриальному сегменту (аналог IamExpat/DutchNews для residential) для мониторинга европейского логистического контекста NL-рынка; для фактов поднимать к первоисточнику.
  - сегменты: индустриал
- ○ **[Retail Dive — Commercial Real Estate & Store Openings](https://www.retaildive.com/topic/real-estate/)** `[откр. · global · непрерывно]`
  - что даёт: Англоязычное отраслевое издание по ритейлу: открытия/закрытия магазинов, сделки по торговой недвижимости, e-commerce vs. физический ритейл, крупные ритейлеры в Европе.
  - аналитику: Англоязычный срез новостей ритейл-сегмента для иностранных инвесторов без доступа к NL-язычным Locatus/RetailTrends; контекст международных ритейл-трендов, влияющих на NL winkelvastgoed; для фактов поднимать к первоисточнику.
  - сегменты: ритейл
- ○ **[Retail Gazette — UK Retail Property News](https://www.retailgazette.co.uk/)** `[откр. · EU · непрерывно]`
  - что даёт: Англоязычное издание по ритейлу с фокусом на Великобританию (крупнейшая аудитория в секторе UK retail), с отдельными материалами по континентальной Европе: сделки, банкротства/реструктуризации ритейлеров, торговые площади и аренда.
  - аналитику: Дополнительный англоязычный новостной канал по коммерческому/ритейл-сегменту (аналог NL Times для residential) для отслеживания панъевропейских ритейл-трендов, релевантных NL winkelcentra; для фактов поднимать к первоисточнику.
  - сегменты: ритейл
- ○ **[CRE Herald — English-language CRE News](https://www.creherald.com/)** `[откр. · EU · непрерывно]`
  - что даёт: Англоязычная новостная лента по коммерческой недвижимости континентальной Европы: инвестсделки, фонды, ритейл и логистика, включая NL-эмитентов (CTP, WDP, Wereldhave).
  - аналитику: Смешанный англоязычный CRE-новостной канал для иностранных инвесторов в NL commercial/industrial без доступа к платным терминалам; для фактов поднимать к первоисточнику.
  - сегменты: ритейл, индустриал
...
- ○ **[Vastgoedwereld](https://vastgoedwereld.nl/)** `[откр. · NL · непрерывно]`
  ...
  - аналитику: Оперативный/контекстный слой; для фактов поднимать к первоисточнику (Правило И-1).
  - сегменты: жильё, ритейл, индустриал
- ○ **[IamExpat — Housing & Real Estate News](https://www.iamexpat.nl/dutch-news-articles?section=housing)** `[откр. · NL · непрерывно]`
  - что даёт: Англоязычный новостной раздел для экспатов: цены на жильё, ипотека, аренда, жилищная политика, гайды по покупке/аренде для иностранцев.
  - аналитику: Быстрый англоязычный срез новостей о жилье и тем, важных для международной аудитории (иностранные покупатели, экспат-аренда, изменения регуляций); для фактов поднимать к первоисточнику.
  - сегменты: жильё
- ○ **[DutchNews.nl — Housing](https://www.dutchnews.nl/category/housing/)** `[откр. · NL · непрерывно]`
  - что даёт: Раздел Housing ежедневного англоязычного издания: цены (со ссылкой на CBS/NVM), аренда, ипотека, жилищная политика.
  - аналитику: Надёжный англоязычный дайджест с опорой на официальную статистику — удобен для быстрой проверки фактов и понятного изложения на английском; для фактов поднимать к первоисточнику.
  - сегменты: жильё
- ○ **[NL Times — Housing Market](https://nltimes.nl/tags/housing-market)** `[откр. · NL · непрерывно]`
  - что даёт: Тег housing market англоязычного новостного портала: сделки, статистика цен, жилищная политика, новое строительство.
  - аналитику: Дополнительный англоязычный новостной канал для оперативного мониторинга темы жилья; для фактов поднимать к первоисточнику.
  - сегменты: жильё
