...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      spacer(36),
      ...bullets([
        [txt('Адрес почти невозможно улучшить. '), txt('До «Третьяковской» 170 метров, до «Новокузнецкой» — 300. В трёхстах метрах Третьяковская галерея, вокруг — Марфо-Мариинская обитель, Покровская и Никольская церкви, музей Островского. Это не «центр» вообще, а конкретно та его часть, которую покупают за атмосферу малоэтажного Замоскворечья.', { bold: true })],
        [txt('Концепция отвечает месту, а не рынку. '), txt('Авторы построили её как композицию городских усадеб с отсылкой к купеческой Москве XVII–XVIII веков; на фасадах предложено разместить двенадцать мозаик утраченных церквей Замоскворечья, сохранённых компанией. Материалы — натуральный камень и металл. Для делюкса это работающий аргумент: такую историю нельзя воспроизвести на другой площадке.', { bold: true })],
      ...
      ...bullets([
        ...
        [txt('Зато сам адрес — тихая часть Хамовников. '), txt('Переулки между Плющихой и Смоленской набережной, малоэтажная застройка, до Москвы-реки триста метров. Рядом Ансамбль имени Александрова, «Пироговка» и посольский квартал вокруг Смоленского бульвара.', { bold: true })],
        [txt('И это самая плотно зажатая площадка. '), txt('Участок всего 0,3 га, вокруг сплошная застройка. В отраслевых публикациях прямо отмечали, что 8 тыс. м² жилья на таком пятне могли не пройти по инсоляции — то, что показатели согласовали в мае 2026 года, само по себе результат.', { bold: true })],
      ]),
      ...
      ...bullets([
        ...
        [txt('Материалы заявлены дорогие. '), txt('Архитектурный бетон с вкраплениями изумрудной керамики и моллированные витражи — то есть гнутое стекло. Для дома на 34 квартиры это заметная часть себестоимости и одновременно главный визуальный аргумент проекта.', { bold: true })],
        [txt('Паркинга ровно по норме и не больше. '), txt('36 машино-мест на 34 квартиры — 1,06 на резиденцию. Для формата со средней квартирой 144 м² это скромно: в этом сегменте на семью обычно приходится две машины, а Якиманка — зона платной парковки.', { bold: true })],
      ]),
