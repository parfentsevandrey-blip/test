...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      note('Три площадки разнесены по трём разным элитным районам: Замоскворечье, Хамовники и Якиманка. Между крайними — «Земледельческим» и «Ордынкой» — около трёх километров. Все три достались «Эталону» одной сделкой — общим у них оказалось происхождение, а не соседство.'),
      ...
      ...bullets([
        [txt('Телефонные станции строили в центре: от них шли медные линии к абонентам, и чем ближе станция к жилому кварталу, тем дешевле обходилась сеть. '), txt('Через сто лет линии не нужны, а участки остались — в местах, где свободной земли под застройку нет. Все три площадки в этой справке — бывшие АТС; первый премиальный дом AURIX в Москве, «Резиденция Омега», тоже строится на месте станции.', { bold: true })],
        ...
        'Бренд AURIX Группа «Эталон» запустила в апреле 2025 года, отдельно от основного бизнеса. Группа тридцать лет работает в массовом и комфорт-классе, и продавать дом за миллиард под той же маркой было бы трудно. К августу 2026 года под AURIX четыре проекта в продаже — два в Москве и два в Петербурге — и три площадки в статусе «Скоро». Заявлено ещё восемнадцать.',
      ]),
      ...
      image('ord_hero.jpg', PX, 420, { after: 30 }),
      caption('Общий вид с улицы: семь этажей, светлый камень, скруглённые эркеры, мансардный уровень.'),
      spacer(34),
      imageTrio(['ord_a.jpg', 'ord_b.jpg', 'ord_c.jpg'],
        ['Фасад по улице зимой', 'Угловой ракурс: дом держит красную линию', 'Внутренний двор с колоннадой']),
      spacer(34),
      imageTrio(['ord_d.jpg', 'ord_e.jpg', 'ord_f.jpg'],
        ['Двор со стороны въезда', 'Входная группа: портал в камне', 'Деталь фасада и лепной карниз']),
      spacer(30),
      note('Визуализации — из портфолио бюро «ЭталонПроект», разработавшего архитектурную концепцию. Это проектные изображения, а не фотографии: дом не построен.'),

      // ─────────────── ORDYNKA: LOCATION ───────────────
      h1('Большая Ордынка, 25 — расположение', { br: true }),
      image('map_ord.jpg', PX, 430, { after: 30 }),
      caption('Красное — участок, тёмное — станции метро с расстоянием по прямой.'),
      spacer(34),
      factSheet(K.cardOrd),
      spacer(36),
      ...bullets([
        [txt('До «Третьяковской» 170 метров, до «Новокузнецкой» — 300, до Третьяковской галереи — 300. '), txt('Вокруг участка Марфо-Мариинская обитель, Покровская и Никольская церкви, музей Островского. Застройка малоэтажная: доминант, которые перекрыли бы виды, в квартале нет.', { bold: true })],
        [txt('Концепция построена как композиция городских усадеб с отсылкой к купеческой Москве XVII–XVIII веков. '), txt('На фасадах предложено разместить двенадцать мозаик утраченных церквей Замоскворечья, сохранённых компанией; материалы — натуральный камень и металл. Двенадцать мозаик привязывают дом к конкретному кварталу: на другой площадке такой набор не соберётся.', { bold: true })],
        [txt('Охранный статус здания АТС стоит проверить отдельно. '), txt('Это Первая московская автоматическая телефонная станция 1927 года; в описаниях проекта её называют памятником раннего конструктивизма. Формального статуса объекта культурного наследия по открытым источникам подтвердить не удалось. От него зависит, идёт речь о реконструкции или о новом строительстве, а значит и сроки, и себестоимость.', { bold: true })],
      ]),

      // ─────────────── ZEMLEDELCHESKY: RENDERS ───────────────
      ...
      image('zem_hero.jpg', PX, 415, { after: 30 }),
      caption('Единственный опубликованный ракурс с улицы: ленточные балконы, скруглённые углы, венчающий объём.'),
      spacer(32),
      image('zem_b.jpg', PX, 280, { after: 30 }),
      caption('Входная группа со стороны двора: барельеф на глухой стене, тёмное благоустройство.'),
      spacer(28),
      note('Это все опубликованные визуализации проекта. Собственной страницы у него нет ни на сайте застройщика, ни в портфолио архитектурного бюро; кадры взяты из отраслевой публикации от 25.08.2026, где три проекта AURIX показаны вместе. Архитектор, этажность и срок сдачи не раскрыты.'),

      // ─────────────── ZEMLEDELCHESKY: LOCATION ───────────────
      h1('Земледельческий, 15 — расположение', { br: true }),
      image('map_zem.jpg', PX, 430, { after: 30 }),
      caption('Красное — участок, тёмное — станция метро с расстоянием по прямой.'),
      spacer(34),
      factSheet(K.cardZem),
      spacer(36),
      ...bullets([
        [txt('Единственная из трёх площадок не у метро. '), txt('До «Смоленской» 650 метров по прямой — минут восемь пешком. По меркам сегмента это не приговор, покупатели здесь ездят на машине, но в связке с самым скромным форматом квартир получается объект, у которого меньше всего аргументов сверх адреса.', { bold: true })],
        [txt('До Москвы-реки триста метров, вокруг переулки между Плющихой и Смоленской набережной. '), txt('Застройка малоэтажная, транзитного движения нет. По соседству Ансамбль имени Александрова, «Пироговка» и посольский квартал вдоль Смоленского бульвара.', { bold: true })],
        [txt('Участок 0,3 га — вдвое меньше, чем нужно для 8 тыс. м² жилья при обычной для центра плотности. '), txt('Вокруг сплошная застройка, и в отраслевых публикациях отмечали, что проект мог не пройти по инсоляции. Показатели согласовали в мае 2026 года — значит, вопрос сняли, но запаса по плотности у площадки не осталось.', { bold: true })],
      ]),
      ...
      image('pol_hero.jpg', PX, 420, { after: 30 }),
      caption('Общий вид: девять этажей, белые фасады, скруглённые углы, аркада по первому этажу.'),
      spacer(34),
      imageTrio(['pol_a.jpg', 'pol_b.jpg', 'pol_c.jpg'],
        ['Вид вдоль переулка', 'Аркада и керамика в цоколе', 'Двор: «зелёная чешуя»']),
      spacer(34),
      imageTrio(['pol_d.jpg', 'pol_e.jpg', 'pol_f.jpg'],
        ['Благоустройство по мотивам Врубеля', 'Входная группа со двора', 'Фасадный узор и витражи']),
      spacer(30),
      note('Визуализации — из портфолио бюро «ЭталонПроект». Это проектные изображения, а не фотографии: дом не построен.'),

      // ─────────────── POLYANKA: LOCATION ───────────────
      h1('Малая Полянка, 3 — расположение', { br: true }),
      image('map_pol.jpg', PX, 430, { after: 30 }),
      caption('Красное — участок, тёмное — станция метро с расстоянием по прямой.'),
      spacer(34),
      factSheet(K.cardPol),
      spacer(36),
      ...bullets([
        [txt('До метро «Полянка» 250 метров, до старой Третьяковки — пять минут пешком. '), txt('Именно эта близость к галерее, по словам авторов концепции, и подсказала «сказочный образ» с отсылкой к русскому фольклору: белоснежный объём с мягким силуэтом, а благоустройство, наоборот, тёмное и глубокое — по мотивам Врубеля.', { bold: true })],
        [txt('Фасады заявлены из архитектурного бетона с вкраплениями изумрудной керамики и моллированных витражей — то есть гнутого стекла. '), txt('Гнутое стекло дороже плоского в несколько раз, а на 34 квартиры распределять эти затраты не на что. Отсюда и цена метра: облик проекта оплачивается из неё напрямую.', { bold: true })],
        [txt('36 машино-мест на 34 квартиры — 1,06 на резиденцию. '), txt('Для формата со средней квартирой 144 м² этого мало: в сегменте на семью обычно приходится две машины, а Якиманка — зона платной парковки.', { bold: true })],
      ]),
      ...
      spacer(40),
      ...bullets([
        [txt('Экономика всех трёх держится на цене метра, потому что метража мало. '), txt('От 4,9 до 17,3 тыс. м² на проект. При таких размерах расходы на согласования, архитектуру и стройку ложатся на очень небольшой метраж. Даже если бы застройщик хотел выйти в премиум подешевле, площадки такого размера этого не позволяют.', { bold: true })],
        ...
        [txt('По «Полянке» опубликованы и концепция, и показатели; по «Ордынке» — концепция и общая площадь, но не число квартир; по «Земледельческому» — только показатели. '), txt('Порядок раскрытия совпадает с порядком согласований: «Полянка» вышла на ГЗК в ноябре 2025 года, «Ордынка» в марте 2026-го, «Земледельческий» в мае. Чем позже площадка вошла в работу, тем меньше про неё известно.', { bold: true })],
        [txt('До метро: 170 метров от «Ордынки», 250 от «Полянки» и 650 от «Земледельческого». '), txt('Разрыв вчетверо. Для элитного сегмента пешая доступность метро не решающий фактор, но у «Земледельческого» она складывается с самым скромным форматом квартир — это единственная площадка, где два минуса совпали.')],
      ]),
      ...
      ...bullets([
        ...
        [txt('21,4–23,6 тыс. м² квартир — это 11–12 % от заявленных 200 тыс. м² потенциала застройки, а 64–71 млрд ₽ — 35–38 % от заявленных 185 млрд ₽ выручки. '), txt('То есть треть денег всей программы приходится на одну девятую её метража. Метр на этих трёх участках втрое дороже среднего метра программы: 3 млн против 925 тыс. ₽.', { bold: true })],
      ...
      spacer(40),
      ...bullets([
        [txt('«Русские сезоны» стоят на той же улице и уже продаются: 117–268 м² по 492–917 млн ₽, метр 3,4–4,2 млн ₽, отделка включена, сдача в IV квартале 2026 года. '), txt('С ними «Большая Ордынка, 25» и будет конкурировать напрямую. Разница в сроке — пять лет против нескольких месяцев, и покупателю придётся оценить эти пять лет в деньгах.', { bold: true })],
        [txt('Собственные проекты AURIX цен не раскрывают тоже. '), txt('Ни «Резиденция Омега», ни «Арбат 2» прайс не публикуют — на площадках стоит «цена по запросу». Откалибровать ориентир по уже работающим домам того же застройщика поэтому не получается: цены закрыты по всему портфелю, включая проекты, которые продаются больше года.', { bold: true })],
      ...
      h1('Выводы'),
      ...bullets([
        [txt('Все три площадки пришли одним пакетом — при покупке «Бизнес-Недвижимости» за 14,1 млрд ₽ вместе с ещё 39 объектами. '), txt('У них общее происхождение, один девелопер и одна очередь согласований, поэтому и сроки, и ценовая политика по ним будут связаны: задержка или неудачный старт на одной площадке отразится на остальных.', { bold: true })],
