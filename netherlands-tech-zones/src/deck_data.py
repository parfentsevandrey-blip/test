...
PROFILES = {
    "asml": {
        ...
        "stats": [("~120 га", "площадь"), ("ASML", "якорь"), ("A2 · A67", "магистрали"),
                  ("Brainport", "регион"), ("Чипы", "профиль"), ("Máxima MC", "сосед")],
        "desc": [
            ...
            "Кампус ASML — с офисами, чистыми комнатами и заводскими цехами — занимает здесь огромную территорию.",
        ],
        "highlights": [
            "Кампус ASML: офисы, чистые комнаты и заводские цеха; новые башни De Run 1000 (с 2025)",
            "Рядом — десятки поставщиков ASML: VDL ETG, Sioux, Prodrive и другие",
            "Одна из самых стратегически важных промзон в мире",
        ],
    },
    "htc": {
        "zone_title": "High Tech Campus Eindhoven", "type": "Открытый R&D-кампус",
        "stats": [("~1 км²", "площадь"), ("300+", "компаний"), ("~12 500", "исследователей"),
                  ("~185 000 м²", "офисы"), ("~45 000 м²", "НИОКР"), ("1998", "основан")],
        "desc": [
            "Кампус создан компанией Philips в 1998 году как закрытый центр исследований, а в 2003 году открылся для других компаний.",
            "Сегодня это витрина «открытых инноваций»: сотни компаний делят между собой лаборатории, чистые комнаты и дорогое оборудование.",
        ],
        "highlights": [
            "Модель «открытых инноваций»: общие лаборатории и чистые комнаты",
            "На кампус приходится почти 40% патентных заявок Нидерландов",
            "Резиденты: NXP, Signify, imec/Holst, Philips Research; ~85 национальностей",
        ],
    },
    "nijmegen": {
        "zone_title": "Winkelsteeg и Novio Tech Campus", "type": "Промзона и технокампус",
        "stats": [("~25 га", "Novio Tech"), ("85+", "компаний"), ("4 500+", "работников"),
                  ("17", "зданий"), ("с 1953", "чипы здесь"), ("Чипы+медтех", "профиль")],
        "desc": [
            ...
            "Её ядро — Novio Tech Campus на бывшей территории Philips/NXP, где работают десятки компаний в области чипов и медтехники.",
        ],
        "highlights": [
            "Ядро кластера — бывшая территория Philips/NXP",
            "По соседству — заводы NXP (фабрика ICN8), Nexperia и Ampleon",
            "ICN8 — крупнейшая фабрика чипов NXP в Европе",
        ],
    },
    "amsterdam": {
        "zone_title": "Amsterdam Science Park", "type": "Научный парк",
        "stats": [("~70 га", "площадь"), ("170+", "компаний"), ("10 000+", "человек"),
                  ("AMS-IX", "узел"), ("Город + UvA", "девелопер"), ("Наука+ЦОД", "профиль")],
        "desc": [
            "Один из крупнейших научных парков Европы, созданный совместно городом Амстердамом и Амстердамским университетом (UvA).",
            "Здесь соседствуют университетские факультеты, исследовательские институты, дата-центры и стартапы.",
        ],
        "highlights": [
            "Университетские факультеты и институты: Nikhef, CWI, SURF",
            "Дата-центры Equinix и Digital Realty (Interxion)",
            "CWI — родина языка Python; SURF — суперкомпьютер Snellius",
        ],
    },
    "eemshaven": {
        "zone_title": "Эмсхавен — «Зелёный дата-порт»", "type": "Морской порт и промзона",
        "stats": [("Морпорт", "тип зоны"), ("Google", "якорный ЦОД"), ("380 кВ", "энергоузел"),
                  ("Ветер", "чем питается"), ("NorNed", "подв. кабель"), ("Seaports", "оператор порта")],
        "desc": [
            "Эмсхавен — глубоководный морской порт на севере страны, которым управляет компания Groningen Seaports.",
            "Это не обычный дата-центровый парк, а целая энергетическая промзона: ветропарки, электростанции и выходы подводных кабелей.",
        ],
        "highlights": [
            "Ветропарки и электростанции прямо в промзоне",
            "Узлы энергосети 380 кВ и станции подводных кабелей NorNed, COBRA (TenneT)",
            "Первый в мире ЦОД Google на 100% зелёной энергии",
        ],
    },
    "agriport": {
        "zone_title": "Agriport A7", "type": "Спланированный бизнес-парк",
        "stats": [("1000+ га", "мастер-план"), ("~480 га", "теплицы"), ("A7", "магистраль"),
                  ("Agriport BV", "девелопер"), ("ЦОД+агро", "профиль"), ("Геотермия", "тепло")],
        "desc": [
            "Agriport A7 — бизнес-парк, спланированный «с нуля» на площади более 1000 гектаров вдоль магистрали A7.",
            "Его придумали как энергетический симбиоз: гигантские теплицы и дата-центры делят электроэнергию, тепло и инфраструктуру.",
        ],
        "highlights": [
            "Теплицы и дата-центры делят энергию, тепло и сети",
            "Резиденты дата-центров: Microsoft, Google, CyrusOne",
            "~20% всех томатов страны; центр споров об энергии и воде",
        ],
    },
    "delft": {
        "zone_title": "Кампус TU Delft и Technopolis", "type": "Университетский научный парк",
        "stats": [("TU Delft", "кампус"), ("Technopolis", "научный парк"), ("500+", "стартапов"),
                  ("QuTech", "якорь"), ("€615 млн", "Quantum Delta"), ("Кванты", "профиль")],
        "desc": [
            ...
            "Здесь наука и бизнес переплетены плотнее всего — институт, лаборатории и молодые компании в пределах пешей прогулки.",
        ],
        "highlights": [
            "Институт QuTech (TU Delft + TNO) и лаборатория Microsoft Quantum",
            "Инкубатор YES!Delft — 500+ стартапов",
            "Спин-оффы: QuantWare, Qblox и другие квантовые компании",
        ],
    },
}
