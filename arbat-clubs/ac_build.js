...
const doc = new Document({
  ...
  description: 'Два клубных дома MR Group на Арбате: параметры, поквартирный прайс, структура цены и окрестная когорта',
  ...
  sections: [{
    ...
    children: [
      ...
      body('Дальше — параметры обоих домов бок о бок, поквартирный прайс со ссылками на объявления, разбор структуры цены по этажам и площадям, планировки и когорта предложения в километре вокруг.', { after: 220 }),
      ...
      body('Шестнадцать групп с самым дорогим метром. Полоса показывает, насколько широко расходятся цены внутри одного дома: там, где лотов много, разброс достигает двух с половиной раз.', { after: 190 }),
      image('chart_cohort.jpg', PX, 377, { after: 30 }),
      ...
      ...bullets([
        ...
        [txt('Рынок сегмента сжимается по сделкам и растёт по цене. '), txt('За год объём продаж упал на 45 %, средняя площадь проданного лота — со 116 до 99 м², а цена предложения выросла на 9 %. Годовая экспозиция лотов обоих домов ложится ровно в эту картину.', { bold: true })],
      ]),
      spacer(30),
      note('Данные NF Group. Средневзвешенная цена предложения по элитному сегменту выросла на 3 % за квартал и на 9 % за год, при этом объём сделок упал на 45 % год к году, а средняя площадь проданного лота — со 116 до 99 м².'),
      ...
      ...bullets([
        ...
        [txt('Два дома конкурируют между собой сильнее, чем с локацией. '), txt(`В ${N.between} метрах друг от друга, у одного застройщика, с одной медианой метра и одним сроком ключей они делят один и тот же спрос. Между собой их различают площадь лота, высота потолков и этаж.`, { bold: true })],
