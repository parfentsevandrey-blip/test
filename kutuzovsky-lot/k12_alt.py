...
LOTS = [
    ...
    ('Neva Towers*', '124,0 м², эт. 43/79',        'Дизайнерский', 160_000_000, 124.0,
     Y % '9038336977317031635', 'Яндекс →', 'ph5.jpg', 'дизайнерский · апартаменты'),
    ('Neva Towers*', '111,0 м², эт. 62/77',        'Дизайнерский', 149_000_000, 111.0,
     Y % '8079429590381472257', 'Яндекс →', 'ph6.jpg', 'дизайнерский · апартаменты'),
