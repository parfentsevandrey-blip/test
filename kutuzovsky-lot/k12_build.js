  ...
  sections: [{
    ...
    children: [
      ...
      ...bullets([
        ...
        'Если цена остаётся 162,5 млн ₽, сделка упирается в один сценарий: покупатель, которому нужен именно этот дом, именно этот этаж и именно этот ремонт и который не рассматривает Москва-Сити. Такой покупатель существует, но ждать его придётся долго.',
      ]),
