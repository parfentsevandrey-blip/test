...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      image('floor.jpg', PX, 257, { after: 50 }),
      ...
      h2('Причина 2. Лот конкурирует сам с собой', { br: true }),
      ...bullets([
      ...
      h2('Причина 3. За те же деньги локация даёт больше'),
      ...bullets([
        [txt('Capital Towers, 102,7 м² за 162,2 млн ₽ — ровно наш бюджет. '), txt('На 7,7 м² больше, дизайнерский ремонт с мебелью, 54-й этаж, панорама Москва-Сити, дом 2023 года. Метр там стоит 1 579 200 ₽ против наших 1 710 526 ₽.', { bold: true })],
        'Capital Towers, 130,0 м² с дизайнерским ремонтом — 156,0 млн ₽: плюс 35 м² и на 6,5 млн ₽ дешевле.',
        'Всего в Москва-Сити и Capital Towers 255 готовых лотов, 111 из них с ремонтом. Это не отложенный спрос и не стройка — это то, что покупатель может купить сегодня вместо нашей квартиры.',
      ]),
      ...
      spacer(60),
      callout('Что с этим делать', [
        [txt('Лот переоценён на 12,5–18,0 млн ₽ относительно собственного дома. Это не оценка на глаз: столько остаётся, если из разницы с квартирой-близнецом вычесть рыночную надбавку за четыре этажа.')],
        [txt('Ориентир для сделки — '), txt('145–152 млн ₽ (1,53–1,60 млн ₽/м²).', { bold: true }), txt(' Нижняя граница — паритет с близнецом на втором этаже с поправкой на этаж. Верхняя — уровень, на котором лот становится заметно дешевле Capital Towers за те же 162 млн ₽ и дешевле соседней квартиры за 158,0 млн ₽.')],
        [txt('Если цена остаётся 162,5 млн ₽, сделка упирается в один сценарий: покупатель, которому нужен именно этот дом, именно этот этаж и именно этот ремонт и который не рассматривает Москва-Сити. Такой покупатель существует, но ждать его придётся долго.')],
      ]),
