...
Дата: 2026-09-26 (версия 1.0.2). Сборка: ветка `claude/dazzling-thompson-cpvvtq`.

**Главное ограничение:** реального устройства не было. Версия 1.0.1 прогнана в эмуляторе
Android 17 (раздел ниже); 1.0.2 отличается от неё одним исправлением выбора набора Snowflake
(см. «Изменения 1.0.2») и в эмуляторе не прогонялась. Утечки, смена Wi-Fi ↔ LTE, Doze, батарея,
скорость и российские сети — **не проверены**. Чек-лист для ручной проверки — в [README](../README.md#проверка-на-устройстве-чек-лист).
...
Итого JVM-тестов (включая UI- и скриншот-тесты `:app`): 134, падений нет.
