        ...
        item {
            SettingGroup {
                ...
                SettingRow(
                    index = 1,
                    count = 2,
                    title = stringResource(R.string.wx_glass_edges),
                    hint = stringResource(R.string.wx_glass_edges_hint),
                    checked = settings.glassEdges,
                    onChange = { model.setGlassEdges(it) },
                )
            }
        }
