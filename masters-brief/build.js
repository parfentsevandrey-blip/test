...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      ...bullets([
        [txt('По удельной цене ('), txt(`${T.meta.w} ₽/м²`, { bold: true }), txt(') проект находится существенно выше реализованных проектов бизнес-класса локации — «Лайнер» (ориентировочно 493 тыс. ₽/м² на вторичном рынке) и «Династия» (предложения от 490 тыс. ₽/м²).')],
        'По отношению к «Прайм Парку» — единственному сопоставимому по классу реализованному проекту локации, где цены находятся в диапазоне примерно 651 тыс. — 1,6 млн ₽/м², — МАСТЕРС расположен в нижней-средней части ценового коридора при существенно более раннем сроке ввода (2029 г. против уже сданных корпусов).',
        ...
        'Ключевые риски: ранняя стадия строительства (готовность около 1 %) при сроке ввода IV кв. 2029 г. и отсутствие отделки во всех лотах экспозиции — что увеличивает совокупный бюджет покупки.',
      ]),
