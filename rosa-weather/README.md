...
- **жидкое касание**: палец продавливает стекло в линзу — то, что под ним, увеличивается и
  ловит свет; касание отпускает затухающую серию кругов ряби, которые преломляют сцену и
  вспыхивают на гребнях;
...
размытий, ничего не рисуется на каждом кадре, если ничего не изменилось.
