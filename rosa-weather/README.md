...
студии): лаунчер не даёт преломлять обои, поэтому фаска нарисована так, как на ней ведёт себя
свет, — френелевская полоса внутри края с парой диагональных бликов, тень толщины, вторая кромка
там, где фаска переходит в плоскость, голубая и розовая дисперсионные каймы и искры на углах.
