...
## Календарь: месяц над картиной своего сезона

<img src="docs/images/widgets-calendar-months.jpg" width="100%" />

Четвёртый виджет — «Роса · Календарь»: месяц сеткой, а за ним картина его времени года, у каждого
месяца своя, по мотивам русского пейзажа:

- **Зима:** декабрь — деревня под полной луной, тёплые окна и дым из труб; январь, «Мороз и
  солнце» — ели под снегом, искрящееся поле, дым столбом; февраль по «Февральской лазури» Грабаря —
  белые берёзы в густо-синем небе.
- **Весна:** март — оттепель, грачи на берёзах, лужи с небом; апрель по «Весне. Большой воде»
  Левитана — берёзы стоят в разливе, проходит дождь, радуга; май — цветущий яблоневый сад, одуванчики.
- **Лето:** июнь — старый дуб на цветущем лугу под кучевыми облаками; июль по «Ржи» Шишкина — сосны
  в поле на закате; август — звездопад над тихим озером, Млечный Путь, стога.
- **Осень:** сентябрь по «Золотой осени» Левитана — берёзы над синей рекой; октябрь — туманное утро в
  багряном лесу, лучи сквозь деревья; ноябрь — первый снег у тёмной реки, голые берёзы, вороны.
...
кроны, ели, земля и вода — один в один (`Painting`, `Shaders`, `Flora`, `SeasonScene`).
...
**Живой сезон** (в стилях «Сезон» и «Стекло»). Как дождь на погодных виджетах, по картине
движется её время года — на сгенерированных векторных плитках, которые лаунчер крутит сам, на своём
потоке отрисовки:

- **Январь:** морозная пыль вспыхивает крестиками на солнце.
- **Февраль и ноябрь:** снег; **декабрь:** снег гуще.
- **Апрель:** дождь.
- **Май:** яблоневые лепестки трепещут на лету.
- **Июнь:** плывёт тополиный пух.
- **Июль:** над рожью загораются светлячки.
- **Август:** в небе падают звёзды, у земли светлячки.
- **Сентябрь и октябрь:** березовые и кленовые листья падают, как настоящие. Они раскачиваются
  маятником, наклоняются в сторону качания и переворачиваются, показывая тёмную изнанку.
- **Март:** стоит тихо, тает.

Плитки у сезонов высокие (180 × 180 dp), в четырёх вариантах по столбцам. Лист, который пролетел
плитку, продолжает падать в следующей под ней, а соседние столбцы не повторяют друг друга.

**Быстрое перелистывание.** Картина месяца стоит несколько сотен миллисекунд. Поэтому каждая
пишется один раз для месяца и размера и хранится: в памяти для виджетов на экране, на диске для
того времени, когда процесс уже выгружен. Вместе с картиной хранится готовая подложка — матовое
стекло и фаска. Соседние месяцы рисуются заранее, в фоне, сразу после каждого обновления. По
стрелке виджет рисует только цифры поверх готовой подложки: около 13 мс против 650 мс с нуля.
Нажатие на стрелки доставляется с приоритетом переднего плана. Заодно ушла скрытая трата во
всех виджетах: переменный шрифт больше не пересобирается на каждую подпись.
...
живой сезон по кадрам (каждая плитка — только то, что крутит поток отрисовки) и задание, которое
ждёт изменений в календарях. Время отрисовки измерено на JVM разработки; на телефоне картина с нуля
будет дольше. Открытие календаря телефона, запрос доступа к событиям, появление новых событий и
скорость перелистывания на виджете нужно проверить на устройстве. Эффекты неба можно ограничить настройкой «Эффекты неба → Эконом».
