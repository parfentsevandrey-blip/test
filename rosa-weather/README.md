...
из того же момента того же прогноза. Лаунчер показывает неподвижную картинку, поэтому виджет —
её фотография: струи за стеклом, капли-линзы на нём (с перевёрнутым небом внутри, тёмной
кромкой, каустикой и бликом), стекающие капли с мокрыми дорожками. В снег — хлопья в две глубины,
в мороз от рамки растёт иней, во влажную погоду стекло запотевает. Всё это лежит под текстом и
цифрами, поэтому они остаются читаемыми. Эффекты есть во всех стилях, кроме «Бумаги»; в
«Прозрачном» капли над обоями — это только кромка и свет. Выключаются вместе с погодными
эффектами в студии.
