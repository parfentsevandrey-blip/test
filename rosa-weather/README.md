...
- **хроматическая дисперсия** на фаске, сильнее в углах, — считается только в полосе фаски,
  поэтому ничего не стоит даже на больших карточках; **вибрантность** (насыщенность ×1,5);
- **френелевская полоса и толщина**: фаска отражает тем больше, чем ближе к краю, и чуть темнеет
  там, где отвёрнута от света; по освещённой половине лежит мягкий глянец;
...
- **производительность**: вся фоновая жизнь — облака, иконки, стрелка ветра, вода — идёт по одним
  ...
  рендерятся в фоне в картинку — так же, как их получает лаунчер.

## Стекло до мелочей: цифры, пиктограммы, иконки

<img src="docs/images/glyphs.jpg" width="100%" />

- **Цифры из жидкого стекла.** Большая температура — не текст с тенью, а стекло. Цифры
  превращаются в две маски: точную форму и мягкое «поле высот», из наклона которого у каждой
  точки глифа появляется нормаль. AGSL-линза преломляет через цифры небо (сильнее всего на
  скруглённых кромках), подсвечивает кромки со стороны света (он следует за наклоном телефона),
  затеняет дальнюю сторону, подкрашивает тело цветом текста, чтобы число читалось над любым
  небом, и отбрасывает мягкую тень. Новое значение не сменяется скачком, а перетекает из старого.
...
включая AGSL-шейдеры (стеклянные цифры тоже). Запуска на физическом
