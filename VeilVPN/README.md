...
> **Готовый DMG:** <https://github.com/parfentsevandrey-blip/test/releases/tag/veil-v0.1.0>
...
- Ограничение страны выхода снижает анонимность — это осознанный компромисс пользователя.
