"""Визуализации двух петербургских проектов AURIX с сайта застройщика.
...
PAGES = {
    'ldm': 'https://aurix-development.ru/projects/ldm',
    'mar': 'https://aurix-development.ru/projects/mariinka',
}
# превью соседних проектов в подвале + служебная графика
SKIP = ('star', 'logo', 'prev_', '_prev', 'malaya_polyanka', 'vid_7', 'Vid18', 'arbat2_arkh', 'render_visual',
