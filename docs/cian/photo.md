...
На сплошной выверке тридцати одной квартиры этот признак оказался самым
недооценённым: на контактном листе сплошная панель без швов читается как
плитка, и четыре лота из двадцати четырёх пришлось поднять со «слэба».
