...
| `renovationInProgress` | видны идущие работы: материалы, инструмент, плёнка, штробы |
...
Порядок правил не косметический. **Следы работ решают раньше голого
бетона**: голый бетон виден в любой квартире посреди ремонта — это фон, а
не отличительный признак. Сначала было наоборот, и целевой пентхаус на
Льва Толстого получил «бетон» при уликах «штабели газоблока, перегородки
выложены наполовину, ограждающая лента, часть стен уже оштукатурена и
покрашена». Разница не в слове: «ремонт идёт» говорит, что деньги в отделку
уже вложены и покупатель наследует чужой наполовину исполненный проект, а
не чистый лист.

**План без перегородок сильнее всего остального.** Стройка на голой плите —
всё равно бетон, сколько бы работ на кадрах ни шло.
